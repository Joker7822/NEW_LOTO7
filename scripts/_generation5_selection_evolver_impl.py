#!/usr/bin/env python3
"""Implementation for Generation 5 Selection-Null finalist screening."""
...
def selection_candidate_key(evidence: Mapping[str, object]) -> tuple[float, ...]:
    ...
    internal_values = tuple(_number(value, 0.0) for value in internal) if isinstance(internal, list) else ()
    return (
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    selection_summary: dict[str, object] = {
        ...
        "shortlist": selection_block["shortlist"],
    }
